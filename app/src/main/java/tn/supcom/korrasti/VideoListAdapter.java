...
import tn.supcom.korrasti.content.YouTubeContent;
...
public class VideoListAdapter extends BaseAdapter implements YouTubeThumbnailView.OnInitializedListener {
    ...
    @Override
    public int getCount() {
        return tn.supcom.korrasti.content.YouTubeContent.ITEMS.size();
    }

    @Override
    public Object getItem(int position) {
        return tn.supcom.korrasti.content.YouTubeContent.ITEMS.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final tn.supcom.korrasti.content.YouTubeContent.YouTubeVideo item = tn.supcom.korrasti.content.YouTubeContent.ITEMS.get(position);
