package tn.supcom.korrasti.content;
...
public class YouTubeContent {
    ...
    static {
        addItem(new YouTubeVideo("yk_mEzOq1i0", "Open in the YouTubeFragment"));
        addItem(new YouTubeVideo("xYMgdW7-s9E", "Open in the YouTubeFragment"));
        addItem(new YouTubeVideo("2WHY5L5fAeA", "Open in the YouTubeFragment"));
        addItem(new YouTubeVideo("wYijSBXF6SM", "Open in the YouTubeFragment"));
        addItem(new YouTubeVideo("8lkPUEP0ZQ0", "Open in the YouTubeFragment"));
        addItem(new YouTubeVideo("Zj8FsRGHfI4", "Open in the YouTubeFragment"));
